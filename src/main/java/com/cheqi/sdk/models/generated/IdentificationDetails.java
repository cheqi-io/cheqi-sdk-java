...
/**
 * Identification and payment details used to resolve the receipt recipient. For non-cash payments, you must provide either cardDetails or paymentAccountDetails. For card payments, cardDetails may also include optional lastFourDigits for richer receipt metadata. For cash payments, cardDetails and paymentAccountDetails are not required, but you must provide either recipientEmail or pairingCode.
 */
@JsonPropertyOrder({
...
public class IdentificationDetails {
  ...
  public IdentificationDetails paymentType(@javax.annotation.Nonnull PaymentType paymentType) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYMENT_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPaymentType(@javax.annotation.Nonnull PaymentType paymentType) {
    this.paymentType = paymentType;
  }
  ...
  /**
   * A temporary 6-digit pairing code generated by the receipt recipient.
   * @return pairingCode
   */
  @javax.annotation.Nullable
