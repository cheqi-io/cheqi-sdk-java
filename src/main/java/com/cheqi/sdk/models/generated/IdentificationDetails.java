...
public class IdentificationDetails {
  ...
  public enum PaymentTypeEnum {
    CARD_PAYMENT(String.valueOf("CARD_PAYMENT")),
    
    DIRECT_DEBIT(String.valueOf("DIRECT_DEBIT")),
  ...
  public IdentificationDetails paymentType(@javax.annotation.Nonnull PaymentTypeEnum paymentType) {
